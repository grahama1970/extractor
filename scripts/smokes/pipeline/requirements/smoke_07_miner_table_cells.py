...
# ///
"""
Smoke: Stage 07½ Requirements Miner — table-cell candidates (tolerant)
Ensures the miner runs and reports the count of table_cell-derived requirements (may be zero).
...
def ensure_pipeline() -> Path:
    """Ensure the existence of a requirements JSON file in output."""
...
@app.command()
def main():
    """Extract requirement counts from a JSON input and save to file."""
