...
def main():
    ...
    reflow = {
        "unified_document": {
            ...
            "metadata": {
                "title": "Units Doc",
                "format_metadata": {"source_pdf": "units_conflicts.pdf"},
            },
            "source_type": "pdf",
            "hierarchy": {
                "id": "root",
            ...
            "blocks": [
                {
                    ...
                    "parent_id": "h1",
                    "type": "paragraph",
                    "content": "Mass is 5 kg",
                    "metadata": {"page_number": 1, "bbox": [0, 0, 10, 10]},
                },
                {
                    "id": "b2",
                    "parent_id": "h1",
                    "type": "paragraph",
                    "content": "Mass is 4000 g",
                    "metadata": {"page_number": 1, "bbox": [0, 10, 10, 20]},
                },
            ],
        }
    }
    ...
    cmd10 = [
        sys.executable,
        "-m",
        "extractor.pipeline.steps.10_arangodb_exporter",
        "debug-bundle",
        str(bundle10),
        "-o",
        str(out_dir),
    ...
    (Path("scripts/artifacts") / "stage11_units_conflicts.json").write_text(
        json.dumps({"conflicts": len(conflicts)}, indent=2)
    )
