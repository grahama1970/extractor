...
app = typer.Typer(
    add_completion=False, help="Smoke: Stage 14 report stats from synthetic pipeline dir"
)
...
def main():
    ...
    d(base / "10_arangodb_exporter" / "json_output").joinpath(
        "10_export_confirmation.json"
