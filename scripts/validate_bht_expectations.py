...
def main(results_dir: str) -> int:
    ...
    # 1 figure expected
    fig_count = len(figures.get('figures') or figures.get('result', {}).get('figures') or figures or [])
    ...
    print(f"Sections: {sec_count} (expect 1), Figures: {fig_count} (expect 1), Merged tables: {merged_tables} (expect 1)")
