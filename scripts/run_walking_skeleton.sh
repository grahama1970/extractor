...
FIGURE_DESC=${FIGURE_DESC:-0}
DESC_FLAG="--skip-descriptions"
case "${FIGURE_DESC,,}" in 1|true|yes) DESC_FLAG="";; esac
...
if [[ "${PROFILE}" == "prod" ]]; then
  STAGE07_INCLUDE_FIGURES=${STAGE07_INCLUDE_FIGURES:-0} \
  STAGE07_ATTACH_SECTION_IMAGE=${STAGE07_ATTACH_SECTION_IMAGE:-0} \
