...
app = typer.Typer(
    help="Run expert-level code review via Codex exec with strict, structured markdown output"
)
    ...
    async def _go():
        await _post_log(
            api_base,
            {
                ...
                "variant": variant,
                "stream": "app",
                "source": "codex_code_review",
                "message": f"Starting code review for {len(files)} files",
                "meta": {},
            },
        )
