...
- Output Dir: /home/graham/workspace/experiments/extractor/workspace/runs/20250913-151354/instances/codex_01_mul_shift_add
...
```
python scripts/variant_agent.py --approach mul_shift_add --bench bench/multiply_benchmark.py --baseline src/core/multiply.py --variants /home/graham/workspace/experiments/extractor/workspace/runs/20250913-151354/instances/codex_01_mul_shift_add/variants.py --out-dir /home/graham/workspace/experiments/extractor/workspace/runs/20250913-151354/instances/codex_01_mul_shift_add --epsilon 0.15 --window 5 --max-iters 8 --run-id 20250913-151354 --prompt-file /home/graham/workspace/experiments/extractor/workspace/runs/20250913-151354/instances/codex_01_mul_shift_add/prompt.md
```

## Monitoring
- Web logs: http://localhost:8000/proto/dashboard
- API scoreboard: http://localhost:8000/scoreboard?run_id=20250913-151354
- API episodes (latest): http://localhost:8000/episodes?run_id=20250913-151354&variant=mul_shift_add&limit=1
- API logs (tail): http://localhost:8000/logs?run_id=20250913-151354&variant=mul_shift_add&limit=50
