...
- Variant: mul_chunked
- Output Dir: /home/graham/workspace/experiments/extractor/workspace/runs/20250913-151324/instances/codex_03_mul_chunked
...
```
python scripts/variant_agent.py --approach mul_chunked --bench bench/multiply_benchmark.py --baseline src/core/multiply.py --variants /home/graham/workspace/experiments/extractor/workspace/runs/20250913-151324/instances/codex_03_mul_chunked/variants.py --out-dir /home/graham/workspace/experiments/extractor/workspace/runs/20250913-151324/instances/codex_03_mul_chunked --epsilon 0.15 --window 5 --max-iters 8 --run-id 20250913-151324 --prompt-file /home/graham/workspace/experiments/extractor/workspace/runs/20250913-151324/instances/codex_03_mul_chunked/prompt.md
```

## Monitoring
- Web logs: http://localhost:8000/proto/dashboard
- API scoreboard: http://localhost:8000/scoreboard?run_id=20250913-151324
- API episodes (latest): http://localhost:8000/episodes?run_id=20250913-151324&variant=mul_chunked&limit=1
- API logs (tail): http://localhost:8000/logs?run_id=20250913-151324&variant=mul_chunked&limit=50
