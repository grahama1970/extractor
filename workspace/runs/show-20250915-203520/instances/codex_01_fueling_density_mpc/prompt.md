...
- Output Dir: /home/graham/workspace/experiments/extractor/workspace/runs/show-20250915-203520/instances/codex_01_fueling_density_mpc
...
```
python scripts/variant_agent.py --approach fueling_density_mpc --bench bench/multiply_benchmark.py --baseline src/core/multiply.py --variants /home/graham/workspace/experiments/extractor/workspace/runs/show-20250915-203520/instances/codex_01_fueling_density_mpc/variants.py --out-dir /home/graham/workspace/experiments/extractor/workspace/runs/show-20250915-203520/instances/codex_01_fueling_density_mpc --epsilon 0.15 --window 5 --max-iters 8 --run-id show-20250915-203520 --prompt-file /home/graham/workspace/experiments/extractor/workspace/runs/show-20250915-203520/instances/codex_01_fueling_density_mpc/prompt.md --api-base http://127.0.0.1:43505
```

## Monitoring
- Web logs: http://localhost:5199
- API scoreboard: http://127.0.0.1:43505/scoreboard?run_id=show-20250915-203520
- API episodes (latest): http://127.0.0.1:43505/episodes?run_id=show-20250915-203520&variant=fueling_density_mpc&limit=1
- API logs (tail): http://127.0.0.1:43505/logs?run_id=show-20250915-203520&variant=fueling_density_mpc&limit=50
