# Gamified Instance Prompt — codex_03 / heat_extraction_adaptive
...
- Variant: heat_extraction_adaptive
- Output Dir: /home/graham/workspace/experiments/extractor/workspace/runs/show-20250915-204153/instances/codex_03_heat_extraction_adaptive
...
```
python scripts/variant_agent.py --approach heat_extraction_adaptive --bench bench/multiply_benchmark.py --baseline src/core/multiply.py --variants /home/graham/workspace/experiments/extractor/workspace/runs/show-20250915-204153/instances/codex_03_heat_extraction_adaptive/variants.py --out-dir /home/graham/workspace/experiments/extractor/workspace/runs/show-20250915-204153/instances/codex_03_heat_extraction_adaptive --epsilon 0.15 --window 5 --max-iters 8 --run-id show-20250915-204153 --prompt-file /home/graham/workspace/experiments/extractor/workspace/runs/show-20250915-204153/instances/codex_03_heat_extraction_adaptive/prompt.md --api-base http://127.0.0.1:43009 --S_digits 3 --S_trials 1 --M_digits 6 --M_trials 1 --L_digits 8 --L_trials 1 --L_timeout_ms 250
```

## Monitoring
- Web logs: http://localhost:5199
- API scoreboard: http://127.0.0.1:43009/scoreboard?run_id=show-20250915-204153
- API episodes (latest): http://127.0.0.1:43009/episodes?run_id=show-20250915-204153&variant=heat_extraction_adaptive&limit=1
- API logs (tail): http://127.0.0.1:43009/logs?run_id=show-20250915-204153&variant=heat_extraction_adaptive&limit=50
