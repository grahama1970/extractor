...
- Variant: mul_chunked
- Output Dir: /home/graham/workspace/experiments/extractor/workspace/runs/test-wait-1757785816/instances/codex_03_mul_chunked
...
## Mechanics
Block (schoolbook) multiplication in a fixed base (e.g., 10^k). Represent operands as arrays of base‑digits, accumulate products with carries, then rebuild the integer. Emphasizes clarity over asymptotic optimality.
...
```
python scripts/variant_agent.py --approach mul_chunked --bench bench/multiply_benchmark.py --baseline src/core/multiply.py --variants /home/graham/workspace/experiments/extractor/workspace/runs/test-wait-1757785816/instances/codex_03_mul_chunked/variants.py --out-dir /home/graham/workspace/experiments/extractor/workspace/runs/test-wait-1757785816/instances/codex_03_mul_chunked --epsilon 0.15 --window 5 --max-iters 8 --run-id test-wait-1757785816 --prompt-file /home/graham/workspace/experiments/extractor/workspace/runs/test-wait-1757785816/instances/codex_03_mul_chunked/prompt.md
```

## Monitoring
- Web logs: http://localhost:8000/proto/dashboard
- API scoreboard: http://localhost:8000/scoreboard?run_id=test-wait-1757785816
- API episodes (latest): http://localhost:8000/episodes?run_id=test-wait-1757785816&variant=mul_chunked&limit=1
- API logs (tail): http://localhost:8000/logs?run_id=test-wait-1757785816&variant=mul_chunked&limit=50
