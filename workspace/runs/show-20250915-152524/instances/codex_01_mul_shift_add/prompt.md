...
- Output Dir: /home/graham/workspace/experiments/extractor/workspace/runs/show-20250915-152524/instances/codex_01_mul_shift_add
...
```
python scripts/variant_agent.py --approach mul_shift_add --bench bench/multiply_benchmark.py --baseline src/core/multiply.py --variants /home/graham/workspace/experiments/extractor/workspace/runs/show-20250915-152524/instances/codex_01_mul_shift_add/variants.py --out-dir /home/graham/workspace/experiments/extractor/workspace/runs/show-20250915-152524/instances/codex_01_mul_shift_add --epsilon 0.15 --window 5 --max-iters 8 --run-id show-20250915-152524 --prompt-file /home/graham/workspace/experiments/extractor/workspace/runs/show-20250915-152524/instances/codex_01_mul_shift_add/prompt.md --api-base http://127.0.0.1:41345 --S_digits 3 --S_trials 1 --M_digits 6 --M_trials 1 --L_digits 8 --L_trials 1 --L_timeout_ms 250
```

## Monitoring
- Web logs: http://localhost:5199
- API scoreboard: http://127.0.0.1:41345/scoreboard?run_id=show-20250915-152524
- API episodes (latest): http://127.0.0.1:41345/episodes?run_id=show-20250915-152524&variant=mul_shift_add&limit=1
- API logs (tail): http://127.0.0.1:41345/logs?run_id=show-20250915-152524&variant=mul_shift_add&limit=50
