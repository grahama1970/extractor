...
- Output Dir: /home/graham/workspace/experiments/extractor/workspace/runs/test-wait-1757782712/instances/codex_01_mul_shift_add
...
```
python scripts/variant_agent.py --approach mul_shift_add --bench bench/multiply_benchmark.py --baseline src/core/multiply.py --variants /home/graham/workspace/experiments/extractor/workspace/runs/test-wait-1757782712/instances/codex_01_mul_shift_add/variants.py --out-dir /home/graham/workspace/experiments/extractor/workspace/runs/test-wait-1757782712/instances/codex_01_mul_shift_add --epsilon 0.15 --window 5 --max-iters 8 --run-id test-wait-1757782712 --prompt-file /home/graham/workspace/experiments/extractor/workspace/runs/test-wait-1757782712/instances/codex_01_mul_shift_add/prompt.md
```

## Monitoring
- Web logs: http://localhost:8000/proto/dashboard
- API scoreboard: http://localhost:8000/scoreboard?run_id=test-wait-1757782712
- API episodes (latest): http://localhost:8000/episodes?run_id=test-wait-1757782712&variant=mul_shift_add&limit=1
- API logs (tail): http://localhost:8000/logs?run_id=test-wait-1757782712&variant=mul_shift_add&limit=50
