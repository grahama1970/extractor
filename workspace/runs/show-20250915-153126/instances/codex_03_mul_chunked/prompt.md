...
- Variant: mul_chunked
- Output Dir: /home/graham/workspace/experiments/extractor/workspace/runs/show-20250915-153126/instances/codex_03_mul_chunked
...
```
python scripts/variant_agent.py --approach mul_chunked --bench bench/multiply_benchmark.py --baseline src/core/multiply.py --variants /home/graham/workspace/experiments/extractor/workspace/runs/show-20250915-153126/instances/codex_03_mul_chunked/variants.py --out-dir /home/graham/workspace/experiments/extractor/workspace/runs/show-20250915-153126/instances/codex_03_mul_chunked --epsilon 0.15 --window 5 --max-iters 8 --run-id show-20250915-153126 --prompt-file /home/graham/workspace/experiments/extractor/workspace/runs/show-20250915-153126/instances/codex_03_mul_chunked/prompt.md --api-base http://127.0.0.1:51627 --S_digits 3 --S_trials 1 --M_digits 6 --M_trials 1 --L_digits 8 --L_trials 1 --L_timeout_ms 250
```

## Monitoring
- Web logs: http://localhost:5199
- API scoreboard: http://127.0.0.1:51627/scoreboard?run_id=show-20250915-153126
- API episodes (latest): http://127.0.0.1:51627/episodes?run_id=show-20250915-153126&variant=mul_chunked&limit=1
- API logs (tail): http://127.0.0.1:51627/logs?run_id=show-20250915-153126&variant=mul_chunked&limit=50
