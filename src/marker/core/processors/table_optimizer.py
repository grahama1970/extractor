...
Example usage:
    from marker.core.processors.table_optimizer import TableOptimizer
...
from marker.core.config.table import TableOptimizerConfig, OptimizationMetric
from marker.core.schema import BlockTypes
from marker.core.schema.document import Document
from marker.core.schema.blocks import Block, Table, TableCell
