...
from marker.core.schema.blocks import Block, Caption, Code, Equation, Figure, \
...
from marker.core.schema.groups import FigureGroup, ListGroup, PageGroup, \
    PictureGroup, TableGroup
from marker.core.schema.text import Line, Span
