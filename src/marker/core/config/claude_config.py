...
from marker.core.processors.claude_verification_system import (
    ClaudeConfig, 
    ClaudeFeature, 
    ClaudeConfigBuilder
)
...
def integrate_claude_with_enhanced_processor(enhanced_processor, claude_config_name: str = "disabled"):
    ...
    from marker.core.processors.claude_verification_system import ClaudeDocumentProcessor, integrate_claude_features
