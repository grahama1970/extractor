...
class ProcessingStrategySelector:
    ...
    def reset_episode(self):
        """Reset for new episode/document batch"""
...
def create_rl_selector(model_path: Optional[Path] = None,
                      exploration_rate: float = 0.2) -> ProcessingStrategySelector:
    """Create and configure RL strategy selector"""
