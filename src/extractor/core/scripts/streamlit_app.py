                                        ...
                                        for image in image_tags:
                                            ...
                                            if image_path in images:
                                                markdown = markdown.replace(
                                                    image_markdown,
                                                    img_to_html(images[image_path], image_alt),
                                                )
                                                return markdown
                                                ...
                                                def get_page_image(pdf_file, page_num, dpi=96):
                                                    if "pdf" in pdf_file.type:
                                                        ...
                                                        png_image = Image.open(pdf_file).convert(
                                                            "RGB"
                                                        )
                                                        return png_image
                                                        ...
                                                        def page_count(pdf_file: UploadedFile):
                                                            if "pdf" in pdf_file.type:
                                                                ...
                                                                def pillow_image_to_base64_string(
                                                                    img: Image,
                                                                ) -> str:
                                                                    buffered = io.BytesIO()
                                                                    img.save(
                                                                                        ...
                                                                                        if (
                                                                                            ...
                                                                                            with (
                                                                                                ...
                                                                                                with open(
                                                                                                    ...
                                                                                                    page_range = config_parser.generate_config_dict()[
                                                                                                        "page_range"
                                                                                                    ]
                                                                                                    first_page = (
                                                                                                        page_range[
                                                                                                        ...
                                                                                                        if (
                                                                                                            ...
                                                                                                            if (
                                                                                                                ...
                                                                                                                with image_placeholder:
                                                                                                                    ...
                                                                                                                    if debug:
                                                                                                                        with col1:
                                                                                                                            debug_data_path = rendered.metadata.get(
                                                                                                                                "debug_data_path"
                                                                                                                            )
                                                                                                                            if debug_data_path:
                                                                                                                                pdf_image_path = os.path.join(
                                                                                                                                    debug_data_path,
                                                                                                                                    f"pdf_page_{first_page}.png",
                                                                                                                                )
                                                                                                                                img = Image.open(
                                                                                                                                    pdf_image_path
                                                                                                                                )
                                                                                                                                st.image(
                                                                                                                                    img,
                                                                                                                                    caption="PDF debug image",
                                                                                                                                    use_container_width=True,
                                                                                                                                )
                                                                                                                                layout_image_path = os.path.join(
                                                                                                                                    debug_data_path,
                                                                                                                                    f"layout_page_{first_page}.png",
                                                                                                                                )
                                                                                                                                img = Image.open(
                                                                                                                                    layout_image_path
                                                                                                                                )
