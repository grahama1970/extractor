"""Shared utilities for document providers (lightweight).

Exports a small set of helpers to enforce cross‑format parity without adding
heavy dependencies. Providers can import from this package path reliably.
"""
