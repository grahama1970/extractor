...
Description: Functions for qa generator operations
...
Example:
    ...
    # Generate QA pairs from extractor output
...
from extractor.core.arangodb.importers import (
...
def extract_question_contexts(
    ...
    """
    Extract contexts from extractor output for question generation.
