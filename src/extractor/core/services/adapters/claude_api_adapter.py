...
from extractor.core.services.claude_unified_simple import unified_claude_service
...
class ClaudeAPIAdapter:
    ...
    def _process_result(
        self, task_result: Dict[str, Any], response_schema: Optional[Type[BaseModel]]
    ) -> Any:
