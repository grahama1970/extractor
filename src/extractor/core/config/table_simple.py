...
PRESET_FAST = SimpleTableConfig(optimize_params=False, use_camelot_fallback=False)

PRESET_BALANCED = SimpleTableConfig(optimize_params=True, max_iterations=3)

PRESET_HIGH_QUALITY = SimpleTableConfig(
    optimize_params=True, max_iterations=5, min_quality_score=0.8, use_camelot_fallback=True
)
