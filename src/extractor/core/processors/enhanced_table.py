...
Example usage:
    from extractor.core.processors.enhanced_table import EnhancedTableProcessor
    from extractor.core.config.table import TableConfig, TABLE_HIGH_QUALITY
...
from extractor.core.processors.table_optimizer import TableOptimizer, TableQualityEvaluator
...
from extractor.core.config.table import (
    TableConfig, 
    CamelotConfig, 
