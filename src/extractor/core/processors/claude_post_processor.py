...
Module: claude_post_processor.py
Description: Implementation of claude post processor functionality
...
from extractor.core.processors.claude_section_verifier import (
    SectionVerificationEngine,
    SectionData
)
from extractor.core.processors.claude_content_validator import (
    ContentValidationEngine,
    ContentData
)
from extractor.core.processors.claude_structure_analyzer import (
...
from extractor.core.config.claude_config import MarkerClaudeSettings
from extractor.core.processors.performance_tracker import PerformanceTracker
