...
Module: enhanced_table_validator.py
...
from extractor.core.schema import Document, Table
from extractor.core.tables.camelot_extractor import CamelotExtractor
import fitz  # PyMuPDF
