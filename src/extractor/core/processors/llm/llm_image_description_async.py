"""
Module: llm_image_description_async.py
Description: Implementation of llm image description async functionality
"""
...
from extractor.core.processors import Processor
