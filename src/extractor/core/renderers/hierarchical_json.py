...
class HierarchicalJSONRenderer(BaseRenderer):
    ...
    def __call__(self, document: Document) -> str:
        ...
        if hasattr(document, "metadata") and "hierarchical_structure" in document.metadata:
    ...
    def _render_hierarchical(self, hierarchical_doc: HierarchicalDocument) -> str:
        ...
        output = {
            ...
            "document_metadata": (
                hierarchical_doc.document_metadata.model_dump()
                if hierarchical_doc.document_metadata
                else {}
            ),
