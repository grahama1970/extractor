#!/usr/bin/env python3
"""
Stage-10: Markdown Exporter — Convert assembled content to linear Markdown.
    ...
    for sec_id, sec_title, p_start, sec_summary in sections:
        ...
        for itype, content, sort_order, meta_json, asset_id in items:
            ...
            if itype == "text":
                ...
                sec_lines.extend(renderer.render_equation(content))
...
if __name__ == "__main__":
    ...
    try:
        ...
        run(args.pipeline_dir, args.pipeline_dir)
