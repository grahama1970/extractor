...
- json_output/annotations.json
  - Keys:
    ...
    - summary.by_kind: dict[str,int] (section, table, figure, header_candidate, table_rejected, reflow_* …)
...
- Live CI (self-hosted):
  ...
  - Requires CHUTES_* env and a resolvable scillm dependency on the runner.
