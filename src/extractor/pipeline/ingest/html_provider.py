    ...
    def _add_text_block(self, text: str, parent_tag: str):
        ...
        self.blocks.append(
            BaseBlock(
                ...
                content=text,
                metadata=BlockMetadata(confidence=1.0, attributes={"tag": parent_tag}),
            )
        )
        ...
        self.blocks.append(
            BaseBlock(
                ...
                metadata=BlockMetadata(
                    confidence=1.0, attributes={"level": level, "tag": tag.name}
                ),
            )
        )
        ...
        for li in tag.find_all("li", recursive=False):
            ...
            self.blocks.append(
                BaseBlock(
                    ...
                    content=text,
                    metadata=BlockMetadata(
                        confidence=1.0, attributes={"list_type": tag.name}  # ul or ol
                    ),
                )
            )
