"""
Stage 05 run orchestration and table extraction logic.

Extracted from 05_table_extractor.py.
"""
import asyncio
import json
import os
...
from extractor.pipeline.utils.debug_utils import ensure_logs_dir, log_timing, write_jsonl
