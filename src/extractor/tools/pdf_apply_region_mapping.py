...
def main():
    ...
    ap.add_argument("--mapping", required=True, help="CSV file with columns id,type,page,x0,y0,x1,y1,expected_json")
    ...
    print("Next: python -m src.extractor.tools.pdf_annotations_to_gold --pdf {out} --repo-root . --force")
