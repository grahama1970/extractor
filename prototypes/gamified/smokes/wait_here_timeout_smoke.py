...
def main():
    cmd = [sys.executable, '-m', 'prototypes.gamified.cli', 'run', '--codebase', '.', '--prompt-file', PROMPT, '--instances', '1', '--sequential', '--instance-timeout-s', '3', '--idle-timeout-s', '3', '--no-autostart-backend', '--no-start-dashboard']
    p = sh(cmd)
