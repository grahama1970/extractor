...
- **REQ-SCI-001**: The system shall maintain audit logs for all configuration changes.
  - Sub-clause A: This requirement applies to all sub-systems.
- **REQ-SCI-002**: Safety-critical sub-systems must undergo weekly diagnostic checks.
  - Sub-clause A: This requirement applies to all sub-systems.