...
def generate_docx():
    ...
    doc.add_paragraph('This is a test document to verify the multi-modal capabilities of the extractor. It contains structured headers, lists, and tables.')

    doc.add_heading('Section 2: Requirements', level=1)
    doc.add_paragraph('REQ-001: The system shall extract text from DOCX files.', style='List Bullet')
